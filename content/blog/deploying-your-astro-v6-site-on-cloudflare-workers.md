...
One small gotcha is that the default configuration provided by `astro add cloudflare` still sends all requests which don't match your prebuilt or public assets to the worker.
